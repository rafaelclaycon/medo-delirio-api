...
final class MedoContent: Model, Content {
    ...
    init(
        ...
        self.creationDate = sound.dateAdded?.iso8601withFractionalSeconds ?? Date().iso8601withFractionalSeconds
    ...
    init(
        ...
        self.creationDate = song.dateAdded?.iso8601withFractionalSeconds ?? Date().iso8601withFractionalSeconds
