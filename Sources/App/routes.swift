...
func routes(_ app: Application) throws {
    ...
    app.get(api, v3, "device-model-history", ":modelName", ":password", use: statisticsController.getDeviceModelHistoryHandlerV3)
    app.get(api, v3, "all-device-model-names", ":password", use: statisticsController.getAllDeviceModelNamesHandlerV3)
    app.get(api, v3, "ios-version-history", ":majorVersion", ":password", use: statisticsController.getIOSVersionHistoryHandlerV3)
    app.get(api, v3, "all-ios-versions", ":password", use: statisticsController.getAllIOSVersionsHandlerV3)
    app.get(api, v3, "ios-version-device-breakdown", ":majorVersion", ":password", use: statisticsController.getIOSVersionDeviceBreakdownHandlerV3)
    ...
    app.get(api, v4, "promo-banner", use: dynamicBannerController.getPromoBannerDataHandlerV4)
